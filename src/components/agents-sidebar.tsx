...
export function AgentsSidebar({ selectedAgentId, onAgentSelect }: AgentsSidebarProps) {
  ...
  const activeCount = agents?.filter((a) => a.status !== "offline").length || 0;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs text-stone-500 truncate">{agent.role}</div>
      </div>
